...
let WalletController = class WalletController {
    ...
    createNewAddress(userId, coinId, body) {
        return __awaiter(this, void 0, void 0, function* () {
            let walletId = (yield this.walletRepo.getWalletForUser(userId)).id;
            return yield this.addressRepo.createAddressForCoin(walletId, coinId, body.stake);
        });
    }
};
__decorate([
...
__decorate([
    routing_controllers_1.Get("/:userId/:coinId"),
    __param(0, routing_controllers_1.Param("userId")), __param(1, routing_controllers_1.Param("coinId")), __param(2, routing_controllers_1.Body()),
    __metadata("design:type", Function),
