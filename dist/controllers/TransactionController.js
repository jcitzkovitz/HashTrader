...
let TransactionController = class TransactionController {
    ...
    getAllTransactionsForUser(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let response = yield this.transactionRepo.getAll({ where: { userId: userId } });
    ...
    getAllTransactionsForUserWithCoin(userId, coinId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let response = yield this.transactionRepo.getAll({ where: { userId: userId, coinId: coinId } });
                return new HelperModels_1.ResponseModel(true, 'The transactions for this user have been selected', response);
            }
            catch (err) {
    ...
    getAllTransactions() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let response = yield this.transactionRepo.getAll();
